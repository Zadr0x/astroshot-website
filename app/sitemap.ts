...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    {
      url: `${baseUrl}/automotive-marketing-kuwait`,
      lastModified: new Date(),
      changeFrequency: "monthly",
      priority: 0.9,
    },
    {
      url: `${baseUrl}/ramadan-campaign-kuwait`,
      lastModified: new Date(),
      changeFrequency: "yearly",
      priority: 0.9,
    },
    {
      url: `${baseUrl}/instagram-management-kuwait`,
      lastModified: new Date(),
      changeFrequency: "monthly",
      priority: 0.9,
    },
    {
      url: `${baseUrl}/national-day-campaign-kuwait`,
      lastModified: new Date(),
      changeFrequency: "yearly",
      priority: 0.9,
    },
    {
      url: `${baseUrl}/event-coverage-kuwait`,
      lastModified: new Date(),
      changeFrequency: "monthly",
      priority: 0.8,
    },
    {
      url: `${baseUrl}/corporate-video-kuwait`,
      lastModified: new Date(),
      changeFrequency: "monthly",
      priority: 0.9,
    },
